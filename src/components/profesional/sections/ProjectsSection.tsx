...
const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    description:
      "A high-performance digital garden and showcase built with a focus on core web vitals and developer experience. Features a fluid Bento-grid layout, custom interactive timelines, and a strictly-typed architecture for seamless scalability.",
    tags: ["#NextJS", "#FramerMotion", "#TypeScript", "#TailwindCSS"],
    image: "/image/alvin-website.png",
    status: "In Progress",
    demoUrl: "#",
    sourceUrl: "https://github.com/CallMeVinX/alvin-website",
  },
  {
    title: "MikroInAja",
    description:
      "A centralized academic dashboard designed to streamline class schedule management for students. Built with a modular architecture to ensure rapid data fetching and high maintainability, providing a seamless UI for real-time academic tracking.",
    tags: ["#ReactJS", "#NodeJS", "#PostgreSQL", "#Express"],
    image: "/image/mikroinaja.png", 
    status: "In Progress",
    demoUrl: "#",
    sourceUrl: "#",
  },
